...
//void CreateExcelFile(TestModelList data)
//{
//    using (SpreadsheetDocument package = SpreadsheetDocument.Create("Output.xlsx", SpreadsheetDocumentType.Workbook))
//    {
//        CreatePartsForExcel(package, data);
//    }
//}

//void CreatePartsForExcel(SpreadsheetDocument document, TestModelList data)
//{
...
//void GenerateWorkbookPartContent(WorkbookPart workbookPart1)
//{
...
//void GenerateWorksheetPartContent(WorksheetPart worksheetPart1, SheetData sheetData1)
//{
...
//SheetData GenerateSheetdataForDetails(TestModelList data)
//{
//    SheetData sheetData1 = new SheetData();
//    sheetData1.Append(new Row());
...
//Row CreateHeaderRowForExcel()
//{
//    Row workRow = new Row();
//    workRow.Append(new Cell());
//    workRow.Append(CreateCell1("Test Id", 2U));
//    workRow.Append(CreateCell1("Test Name", 2U));
//    workRow.Append(CreateCell1("Test Description", 2U));
//    workRow.Append(CreateCell1("Test Date", 2U));
//    return workRow;
//}

//Row GenerateRowForChildPartDetail(TestModel testmodel)
//{
//    Row tRow = new Row();
...
//Cell CreateCell1(string text, uint styleIndex)
//{
//    Cell cell = new Cell();
