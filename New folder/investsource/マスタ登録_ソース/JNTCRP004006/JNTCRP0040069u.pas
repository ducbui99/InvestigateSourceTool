...
{$include ActionInterface.inc} 			 		// ｱｸｼｮﾝｲﾝﾀｰﾌｪｲｽの追加
  TJNTCRP0040069f = class(TForm)
	...
	procedure	fnJNTCRP0040069fOnCreate	(Sender: TObject);
...
var
	JNTCRP0040069f: TJNTCRP0040069f;
...
//***********************************************************************************************************/
//***********************************************************************************************************/
constructor	TJNTCRP0040069f.fnCreateDialog (pRec: Pointer; AOwner: TComponent;
										cDateTimeStr00: TDateTime;
										cDateTimeStr01: TDateTime; cDateTimeEnd01: TDateTime;
										cDateTimeStr02: TDateTime; cDateTimeEnd02: TDateTime;
										cDateTimeStr10: TDateTime; cDateTimeEnd10: TDateTime;
...
//***********************************************************************************************************/
//***********************************************************************************************************/
procedure	TJNTCRP0040069f.CMChildkey (var Msg: TWMKey);
begin
...
//***********************************************************************************************************/
//***********************************************************************************************************/
procedure	TJNTCRP0040069f.fnJNTCRP0040069fOnCreate (Sender: TObject);
var
	strDateTime	 : String;
	strDateFormat: String;

begin
	MJSColorChange (TJNTCRP0040069f (Self), 0, 0, 0, 0, rcCOMMONAREA (m_pRec^.m_pCommonArea^).SysFocusColor);
