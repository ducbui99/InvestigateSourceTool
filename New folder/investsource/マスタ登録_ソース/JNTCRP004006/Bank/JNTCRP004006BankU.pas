//******************************************************************************
//		Project Name	:MJSFX
//		Project Memo	:取引先登録(支払情報)－振込先銀行登録
//						 ※社員登録(振込情報)－振込先銀行登録(HAP100100CBank)を元に作成
//		Project ID		:JNTCRP004006Bank
//						:小島(MSI)
...
// 2005/09/01 H.Kawato Add End
  ...
  TJNTCRP004006BankF = class(TForm)
	MLabel1: TMLabel;
	MLabel2: TMLabel;
	MLabel3: TMLabel;
	MLabel4: TMLabel;
...
procedure TJNTCRP004006BankF.fnShowInpBank(var BankData: TBankData; bBranch: Boolean);
begin
...
//	Retrun		:
//************************************************************************
procedure TJNTCRP004006BankF.CMChildKey(var Msg: TWMKey);
var
	sShift	: TShiftState;
	ACtl	: TWinControl;
begin
...
//**********************************************************************
procedure TJNTCRP004006BankF.BUpdateClick(Sender: TObject);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.BCancelClick(Sender: TObject);
begin
	Close;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.FormShow(Sender: TObject);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.fnFormIni;
var
	i:integer;
begin
...
//					:FALSE	:失敗
//**********************************************************************
function TJNTCRP004006BankF.fnValueCheck(Sender: TObject): boolean;
var
	DMQuery : TMQuery;
	sEdit	: String;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.fnWCTLEnter(Sender: TObject);
begin
//
end;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.fnWCTLExit(Sender: TObject);
var
	DMQuery		: TMQuery;
	sEdit		: String;
	cMessageRec	: TMJSMsgRec;	// 2005/09/01 H.Kawato Add
...
//**********************************************************************
function TJNTCRP004006BankF.fnUpdate: boolean;
var
	DMQuery		:	TMQuery;
	bIsInsert	:	boolean;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.fnDetailSet(sBankCode : String);
var
	DMQuery		:TMQuery;
begin
...
//*		Name		:
//**********************************************************************
procedure TJNTCRP004006BankF.FormClose(Sender: TObject;
...
//*		Event		:KeyPress
//**********************************************************************
procedure TJNTCRP004006BankF.EBankCodeKeyPress(Sender: TObject; var Key: Char);
begin
	//'-'は入力不可
	if Key='-' then
		Abort;
...
//**************************************************************************
procedure TJNTCRP004006BankF.fnFBCharInit;
var
	I:	integer;
begin
	//	ASCIIｺｰﾄﾞｾｯﾄ
...
//				:	ｲﾝﾎﾟｰﾄ時はSPに置き換える
//**************************************************************************
function TJNTCRP004006BankF.fnFBKanaChange(const sBase: string; var sEdit: string;
...
//**********************************************************************
procedure TJNTCRP004006BankF.MFBankCompositionStr(Sender: TObject;
  Value: String);
var
	sKanaText : String;
begin
...
//*		Event		:CompositionStr
//**********************************************************************
procedure TJNTCRP004006BankF.MFBranchCompositionStr(Sender: TObject;
  Value: String);
var
	sKanaText : String;
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.FormCreate(Sender: TObject);
begin
	MjsFontResize(TJNTCRP004006BankF(Self),pointer(pMjsRec));

	recCommon := rcCOMMONAREA(pMjsRec^.m_pCommonArea^);
//	recSystem := rcSYSTEMAREA(pMjsRec^.m_pSystemArea^);		// 2005/09/01 H.kawato Del

	MjsColorChange(TJNTCRP004006BankF(Self),
...
//**********************************************************************
// <BDIC> MOD-STR
//constructor TJNTCRP004006BankF.CreateForm(cForm : TComponent; p : pointer);
constructor TJNTCRP004006BankF.CreateForm(cForm : TComponent; p, p2 : pointer; j : TJNTCommon);
// <BDIC> MOD-END
begin
	pMjsRec		:= p;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.FormDestroy(Sender: TObject);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP004006BankF.fnCmnEditBankCodeOnArrowClick(Sender: TObject);
var
	nBankCode	    : Integer;
// <BDIC> MOD-STR
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
function TJNTCRP004006BankF.fnGetBranchName(sBankCode, sBranchCode : String): Boolean;
var
	DMQuery		:TMQuery;
begin
    Result := False;
...
function TJNTCRP004006BankF.GetBankNCode(sBankCode: String): Double;
var
	strSQL	 : String;
	objQuery : TMQuery;
begin
...
//					XXXXXXXX修正内容
//**********************************************************************
procedure TJNTCRP004006BankF.SessionPractice(iSyori: Integer);
begin
												// 処理区分
...
// <BDIC> ADD-STR
procedure TJNTCRP004006BankF.EBankCodeEnter(Sender: TObject);
begin
    m_ACtl := Screen.ActiveControl;
end;

procedure TJNTCRP004006BankF.EBankCodeExit(Sender: TObject);
var
	nBankCode	    : Integer;
	nBraCode	    : Integer;
    iExpRtn         : Integer;
...
//	History			:	YYYY/MM/DD
//*****************************************************************************
function TJNTCRP004006BankF.GetPayCommonValue(sSection, sKey: String): String;
const
