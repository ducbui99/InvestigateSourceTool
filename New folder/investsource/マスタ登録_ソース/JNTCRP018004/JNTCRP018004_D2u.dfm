object JNTCRP018004_D2f: TJNTCRP018004_D2f
  Left = 286
  Top = 243
  BorderStyle = bsDialog
  Caption = 'JNTCRP018004_D2f'
  ClientHeight = 149
  ClientWidth = 502
  Color = clWhite
  ...
  object DialogEditExCodeNumeric: TMNumEdit
    ...
    TabOrder = 1
    Visible = False
    OnKeyDown = DialogEditExCodeKeyDown
    FormatStr = '0'
    Validate = False
    Zero = True
  end
  object DialogEditAssociation: TMTxtEdit
    ...
    TabOrder = 2
    Text = ''
    OnKeyDown = DialogEditAssociationKeyDown
    ValidChars = ''
  end
  ...
  object DialogButtonRegistration: TMBitBtn
    ...
    ParentFont = False
    TabOrder = 5
    OnClick = DialogButtonRegistrationClick
  end
