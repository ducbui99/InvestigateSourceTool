...
var
  JNTCRP008003DlgF: TJNTCRP008003DlgF;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
constructor TJNTCRP008003DlgF.CreateForm(fOwner:TForm;p: pointer;iCd:integer);
begin
	pAppRec:=p;
	iBankCode:=iCd;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.FormCreate(Sender: TObject);
begin
	...
	fnGrBranchIni;
{
	with rcSYSTEMAREA(pAppRec^.m_pSystemArea^),
	 	 rcCOMMONAREA(pAppRec^.m_pCommonArea^) do
	begin
		MjsColorChange(	Self,
						SysBaseColorB,
						SysBaseColorD,
...
//<DSP>
	...
	MjsFontResize(TJNTCRP008003DlgF(Self),pointer(pAppRec));
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.FormDestroy(Sender: TObject);
var
	i:integer;
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.TViewEnter(Sender: TObject);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.BFindClick(Sender: TObject);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.BOkClick(Sender: TObject);
begin
	//支店ｺｰﾄﾞ0は該当銀行が存在するかも?
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.BCancelClick(Sender: TObject);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.TViewChange(Sender: TObject; Node: TTreeNode);
begin
	//支店ｺｰﾄﾞ
	EBranchCode.Value	:=0;
	//支店名称
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.BFindStartClick(Sender: TObject);
var
	sWhere,sOrder:string;
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.MdBranchAfterScroll(DataSet: TDataSet);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.GrBranchKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
	case Key of
		VK_RETURN:
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.GrBranchDblClick(Sender: TObject);
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.fnTViewIni;
const
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
function TJNTCRP008003DlgF.DoDlg(p:pointer): TModalResult;
var
	sSQL:string;
begin
	piBranchCode:=p;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.fnGrBranchIni;
var
	fFld:TField;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.fnGrBranchSet(sWhere,sOrder:string);
var
	sSQL:string;
begin
	PrgBar.Min		:=0;
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.fnGrBranchSet(Node: TTreeNode);
var
	i:integer;
begin
...
//					:XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
//**********************************************************************
procedure TJNTCRP008003DlgF.CMChildKey(var Key: TWMKey);
var
	sShift:TShiftState;
	sSQL:string;
begin
