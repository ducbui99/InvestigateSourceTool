...
//  修正履歴
//  <ﾏｰｸ>   <修正者>        <修正日>          <修正内容>
//  <>      T.Ogawa(LEAD)   2011/07/06(Wed)   新規作成
//  <#001>  T.Ogawa(LEAD)   2012/02/10(Fri)   Memoコンポーネントの背景色をパネルにあわせる
//=============================================================================
unit JNTCRP004001MsgDlgu;
...
type
  ...
  TJNTCRP004001MsgDlgf = class(TForm)
    ...
    MMessage: TMMemo;
    Image1: TImage;
	procedure fnJNTCRP004001MsgDlgfOnCreate(Sender: TObject);
...
constructor	TJNTCRP004001MsgDlgf.fnCreateDialog (AOwner: TComponent;pRec: Pointer;Mode:Integer);
begin
...
procedure	TJNTCRP004001MsgDlgf.fnJNTCRP004001MsgDlgfOnCreate (Sender: TObject);
begin

	MJSColorChange (TJNTCRP004001MsgDlgf (Self), ComArea.SystemArea.SysColorB,
...
//**************************************************************************
//  Component : TJNTCRP004001MsgDlgf
//  Event     : CMChildKey
//**************************************************************************
procedure TJNTCRP004001MsgDlgf.CMChildKey(var Msg: TWMKey);
begin
...
//  Event     : FormShow
//**************************************************************************
procedure TJNTCRP004001MsgDlgf.FormShow(Sender: TObject);
begin
    // 起動確認のダイアログ
    ...
    MMessage.Color := (MMessage.Parent as TMPanel).Color;  //<#001> ADD
